/**
 * Cliente para obtener y renderizar detalles de carrera del usuario (versión tolerante)
...
class CareerDetailsClient {
    ...
    /**
     * Obtiene los datos de carrera del usuario desde la API (versión tolerante)
