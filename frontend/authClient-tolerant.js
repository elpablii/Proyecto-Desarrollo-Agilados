/**
 * Cliente de autenticación tolerante
 * No redirige inmediatamente al login cuando hay errores de red
 */
...
class AuthClient {
    ...
    /**
     * Verifica si el usuario está autenticado (versión tolerante)
    ...
    startSessionMonitoring() {
        // Verificar sesión cada 15 minutos (menos frecuente)
    ...
    async checkExistingSession() {
        ...
        // Verificar con el método tolerante
    ...
    /**
     * Realiza una petición autenticada (versión tolerante)
    ...
    async authenticatedFetch(url, options = {}) {
        ...
        try {
            ...
            if (error.name === 'TypeError' && error.message.includes('fetch')) {
                console.log('Error de red, NO redirigiendo al login');
